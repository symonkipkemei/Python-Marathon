...
with sqlite3.connect("art_gallery.db") as db:
    cursor = db.cursor()
...
def create_tables():
    """create tables"""
    # artist_contact_details table
    cursor.execute("""CREATE TABLE IF NOT EXISTS artist_contact_details(
...
def insert_table(list_of_id, list_of_piece):
    """insert data into respective fields of the database"""
